...
<body>
	...
	<div class="wrapper">
        ...
        <h4> Видео группа</h4>
        <p>Люди, благодаря которым на нашем ютуб канале есть постоянный развлекательный контент,
				а в социальных сетях регулярно публикуются отчеты со всех мероприятии.</p>
        <p></p>
      </div>
		</div>
